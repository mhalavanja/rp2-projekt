...
function seed_table_hotels()
{
    ...
    try
    {
//        $st = $db->prepare( 'INSERT INTO projekt_hotels(id_user, name, description, price) VALUES (:id_user, :name, :description, :price)' );
//
...
//        $st->execute( array( 'id_user' => 3, 'name' => '30 Used Tennis Balls - Branded. Very Clean.', 'description' => 'Good condition. All are clean. Branded balls. We have sold over 400,000 balls over a 10 year period so you can be sure of getting a great service and product.', 'price' => 16.89 ) ); // ana
    ...
    catch( PDOException $e ) { exit( "PDO error [projekt_hotels]: " . $e->getMessage() ); }
...
//        $st->execute( array( 'id_user' => 3, 'name' => '30 Used Tennis Balls - Branded. Very Clean.', 'description' => 'Good condition. All are clean. Branded balls. We have sold over 400,000 balls over a 10 year period so you can be sure of getting a great service and product.', 'price' => 16.89 ) ); // ana
    ...
    catch( PDOException $e ) { exit( "PDO error [projekt_rooms]: " . $e->getMessage() ); }
...
function seed_table_bookings()
{
    ...
    try
    {
//        $st = $db->prepare( 'INSERT INTO projekt_bookings(id_product, id_user, rating, comment) VALUES (:id_product, :id_user, :rating, :comment)' );
//
...
//        $st->execute( array( 'id_product' => 4, 'id_user' => 1, 'rating' => 5, 'comment' => 'Great tennis balls, I can now play for the whole year!' ) );
    ...
    catch( PDOException $e ) { exit( "PDO error [projekt_bookings]: " . $e->getMessage() ); }
